...
description: Encodes a strong R style preference to avoid scalar if/else control flow — especially nested if/else — whenever a cleaner alternative exists (switch(), named-vector/lookup tables, [...]
---
