...
This repository contains reusable Claude Skills that provide enhanced functionality for various AI tasks. Each skill is self-contained and documented, making it easy to integrate into your Claude workflows.
...
A skill that provides narrative explanations of R (research) methodologies. This skill helps Claude deliver comprehensive, methodology-focused insights for research-related tasks.
